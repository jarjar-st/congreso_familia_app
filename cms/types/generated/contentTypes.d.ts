...
export interface ApiHorarioHorario extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Tipo: Attribute.Enumeration<['apertura', 'charla', 'almuerzo']> &
      Attribute.Required;
    orador: Attribute.Relation<
      'api::horario.horario',
      'manyToOne',
      'api::orador.orador'
    >;
...
export interface ApiOradorOrador extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Biografia: Attribute.Blocks & Attribute.Required;
